	...
	<header class="header">
		...
		<div class="photo">
				...
				<div class="pers-input">
					...
					<input type="text" value="{{$data->profession}}" id="profession" placeholder="{{__('cv_lang.programmer')}}">
				</div>
		</div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
		...
		<div class="textar">
			...
			<textarea id="about_me" value="{{$data->about_me}}" placeholder="{{__('cv_lang.introduce')}}">{{$data->about_me}}</textarea>
		</div>
	</header>
	<main class="main">
		<div id="skill">	
					 ...
					 <div class="skill-method-edu" id={{$ed->id}}>
					    <div class="skill-left">
				           <div>
					          ...
					          <p>
					           <span class="m1">{{$ed->begin_month}}</span><span> - </span><span class="y1">{{$ed->begin_year}}</span> <span class="m2">{{$ed->end_month}}</span><span>{{$line}}</span><span class="y2">{{$ed->end_year}}</span> </p>
	...
	@if(count($data->language)>0)		
		...
		<div class="skill-method-lang" id="{{$lang->id}}">
			<div class="skill-left">
				<div>
					<p ><span class="lang_name">{{$lang->language}}</span><span>&nbsp;-&nbsp;</span><span class="lang_level">{{$lang->level}}</span></p>
				</div>
			</div>
			<div class="skill-right">
				<div>
			...
			<div class="skill-method-ex" id="{{$exp->id}}">
				<div class="skill-left">
					<div>
						...
						<p><span class="comp">{{$exp->company}}</span><span>,</span><span class="st_m">{{$exp->start_month}}</span><span>-</span><span class="st_y">{{$exp->start_year}}</span>
			                        <span class="end_m">{{$exp->end_month}}</span><span>{{$line}}</span><span class="end_y">{{$exp->end_year}}</span></p>
