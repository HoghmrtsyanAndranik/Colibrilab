...
ծրագրավորում php,react ծրագրավորում,ծրագրավորում react,python ծրագրավորում,ծրագրավորում python" />
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/privacy_style.css')}}">

    <link rel="stylesheet" href="{{asset('css/footer.css')}}">
    <link rel='stylesheet' href="{{asset('css/revolution.addon.particles.css?ver=1.0.3')}}" type='text/css' media='all' /> 
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="#eduservices-pricing">{{__('home.courses')}}</a>
                    </li>
                   <li class="nav-item">
                        
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="#eduservices-blog">{{__('home.portfolio')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="#eduservices-teacher">{{__('home.ourteam')}}</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="#eduservices-testimonial">{{__('home.opinions')}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link js-scroll-trigger" href="#eduservices-contact">{{__('home.contact')}}</a>
                    </li>
                    <div class="dropdown">
                    <li class="nav-item other5">
                    <a class="nav-link js-scroll-trigger other6" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{__('home.other')}}
                    </a>
                     <a class="nav-link js-scroll-trigger ana" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{__('main_lang.create_cv')}}
                    </a>
                     <a class="nav-link js-scroll-trigger ana" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{__('main_lang.testspeed')}}
                    </a>
                     <a class="nav-link js-scroll-trigger ana" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">{{__('main_lang.faq')}}
                    </a>


                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="{{url('/#eduservices-contact')}}">{{__('main_lang.contact')}}</a>
                        <a class="dropdown-item" href="{{url('/#createcv')}}">{{__('main_lang.create_cv')}}</a>
                        <a class="dropdown-item" href="{{url('/typing_test')}}" target="_blank">{{__('main_lang.testspeed')}}</a>
                        <a class="dropdown-item" href="{{url('/FAQ')}}" target="_blank">{{__('main_lang.faq')}}</a>
                        <a class="dropdown-item" href="#">{{__('main_lang.opinion')}}</a>
                    </div>
                    </div>
                        </li>
                    <li class="nav-item buttonik">
                        <a class="nav-link js-scroll-trigger  login" href="{{url('register')}}">{{__('home.signup')}}</a>
                    </li>
                    ...
                    <li class="nav-item" id="last-li">
                        <div class="chooseLang">
                         ...
                         @endphp
                            ...
                            <div>
                                <span id="es-lang" class="lang am-lang {{$is_arm}}" onclick="changeLang('arm', this)"></span>
                                <span id="en-lang" class="lang en-lang {{$is_eng}}" onclick="changeLang('en', this)"></span>
                            </div>
                        </div>
                    </li>
...
<div style="display: flex;justify-content: center;padding: 20px 0; height: 0">
 ...
 <section class="footer1">
      ...
      <div class="dropdown ajak hide">
        <div class="  ajakicner" data-toggle="dropdown">
          ...
          <div class="dropdown-menu box" style="margin: 0 12px" x-placement="none !important">
            ...
            <div class="main">
              <div class="img">
              <img src="https://avatars.githubusercontent.com/u/86793772?s=40&u=bb33238cea0bb5533f400efdc5ff378936cc6171&v=4" style="width: 40px; height: 40px; margin-top: 25px; border-radius: 50%; ">
            </div>
            <div class="cont">
              <p>{{__('home.ararat')}}</p>
    ...
    <script type="text/javascript" src="{{asset('js/warning.js')}}"></script>
    <!-- Scroll to top -->
