...
$(document).on('click', "#save-skill",function() {
   ...
   $.ajax({
        ...
        <div class="skill-right">
          <div>
            <img class="delete-range" src="/cv/images/delete.png">
            <img class="edit-range" src="/cv/images/edit.png">
          </div>
        </div>
      </div> `);
...
$(document).on('click',"#save-lang",function() {
   ...
   $.ajax({
       ...
       <div class="skill-right">
          <div>
             <img class="delete_language" src="cv/images/delete.png">
             <img class="upd_language" src="cv/images/edit.png">
          </div>
       </div>
    </div>`);
   ...
   if($(this).hasClass('edit_experiance'))return;
    ...
    success:function(d){
      if(d.success==true){
        ...
        <div class="skill-right">
          <div>
            <img class="delete_experiance" src="cv/images/delete.png">
            <img class="edit_ex" src="cv/images/edit.png">
          </div>
        </div>
      </div>`); 
       ...
       let line=(d.nd_year!=null)?'-':'';
        ...
        <div class="skill-method-edu" id=${d.id}>
              <div class="skill-left">
                 ...
                 <div class="skill-right">
                    <div>
                     <img class="delete_education" src="cv/images/delete.png">
                     <img class="edit_education" src="cv/images/edit.png">
                    </div>
                  </div>
             </div>`);
